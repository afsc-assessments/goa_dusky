...
header-includes:
   ...
   \makeatletter
   \renewcommand{\figurename}{Figure 12-\@gobble}
   \makeatother
   \makeatletter
   \renewcommand{\tablename}{Table 12-\@gobble}
   \makeatother
   \usepackage{titlesec}
...
data_pull2 <- paste(lubridate::month(catch_date, label = TRUE, abbr = FALSE), lubridate::day(catch_date))
```
