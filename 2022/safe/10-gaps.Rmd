...
Last, an examination of incorprating an error inflation parameter to increase the variance in VAST models and explore the effect low survey model variance has on resulting assessment outputs.
