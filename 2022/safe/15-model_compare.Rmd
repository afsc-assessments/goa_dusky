...
```
VAST model E (lognormal) model residuals. 
...
Similar results are observed when both the age and length composition data plus groups are increased (Figures 12c-\@ref(fig:fm22al) and 12c-\@ref(fig:fm22albio)) .
