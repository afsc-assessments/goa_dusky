// dusky rockfish w/increased plus age group - 2022

// read .ctl file
DATA_SECTION
  !!CLASS ofstream evalout("evalout.prj");
// Read data from the control file
  !! ad_comm::change_datafile_name("goa_dr_2020.ctl");    //Read in phases, penalties and priors from "tem.ctl"
...
// Trawl Survey size composition data
 ...
 init_ivector  siz_age_ind_srv1(1,nyrs_srv1_size)    // some measure of relative sample size for each fishery comp
  ...
  !!cout<<"fac = " << oac_fish << endl;
  !!cout<<"fac = " << nyrs_srv1_size << endl;
//* !!cout<<"error? = " << yrs_fish_age << endl;
//  !!cout<<"error? = " << nsamples_fish_age << endl;
//  !!cout<<"error? = " << nhauls_fish_age << endl;
//  !!cout<<"error? = " << oac_fish << endl;
